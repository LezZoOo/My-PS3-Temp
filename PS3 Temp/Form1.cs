    ...
    public partial class Form1 : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void flowButton4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DevExpress.XtraEditors.XtraMessageBox.Show("Impossible to connect, check your IP!", "Error :(", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    labelControl11.Text = "NOT Connected";
                }
                else
                {
                    this.flowButton2.Enabled = true;
                    this.flowButton5.Enabled = true;
                    this.flowButton6.Enabled = true;
                    this.flowButton7.Enabled = true;
        ...
        private void flowButton2_Click(object sender, EventArgs e)
        {
            ...
            this.timer2.Stop();
            this.timer3.Stop();
            DevExpress.XtraEditors.XtraMessageBox.Show("PS3 Temp Disconnected! Bye bye :)", "Disconnected", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
        }
        ...
        private void flowButton5_Click(object sender, EventArgs e)
        {
            ...
            {
                DevExpress.XtraEditors.XtraMessageBox.Show("You have to connect your PS3 before.. .-.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
